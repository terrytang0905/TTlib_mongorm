...
/**
 * @info : Mongo sql config update parser 
 * @author: tangzj
 * @data : 2014-4-21
 * @since : 1.5
 */
@SuppressWarnings("unchecked")
public class ConfigUpdateParser implements NodeParser<Object> {
	...
	public Map<String, Object> mapToMap (MongoSQLContext context, List<MappingEntry> om, Map<String, Object> para) throws Exception {
		...
		for (MappingEntry entry : om) {
			...
			if(Type.IGNORENULL.equals(type) || ParserWapper.isNotNull(v)) {  // operate  表达式操作符  默认为= 
